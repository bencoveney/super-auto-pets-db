...
function Tile({ id, name, stats, packs, background, }) {
    return (react_1.default.createElement("div", { className: "transition group bg-gray-900 hover:bg-black shadow-md flex flex-col items-stretch justify-start max-w-sm cursor-pointer" },
        react_1.default.createElement("div", { className: "relative" },
            ...
            react_1.default.createElement("img", { className: "transition-margin mx-7 my-7 group-hover:mx-3 group-hover:my-3 filter drop-shadow-tile", src: `/assets/${id}.svg` }),
